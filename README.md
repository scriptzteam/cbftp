...
First and foremost, the UI in cbftp is merely a complement to the backend.
...
A: You normally need to press 'd' (as in Done) to save settings when editing.
...
A: Yes with extra steps - it works fine in the Windows Sybsystem for Linux
   (WSL) and/or Cygwin, but you'll need to figure those tools out first.
